...
import com.example.tfg_carwash.databinding.ActivityLavadodeluxeBinding


class DeluxeWashActivity : AppCompatActivity() {
    private lateinit var binding: ActivityLavadodeluxeBinding
    private var userId: Int = -1

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLavadodeluxeBinding.inflate(layoutInflater)
