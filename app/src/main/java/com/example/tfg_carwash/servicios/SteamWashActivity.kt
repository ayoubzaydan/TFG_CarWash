...
import com.example.tfg_carwash.databinding.ActivityVaporBinding

class SteamWashActivity : AppCompatActivity() {
    private lateinit var binding: ActivityVaporBinding
    private var userId: Int = -1


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityVaporBinding.inflate(layoutInflater)
