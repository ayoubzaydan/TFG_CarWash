...
import com.example.tfg_carwash.databinding.ActivityAutoservicioBinding
import com.example.tfg_carwash.databinding.ActivityHistoryBinding

class SelfServeActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAutoservicioBinding
    private var userId: Int = -1


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAutoservicioBinding.inflate(layoutInflater)
